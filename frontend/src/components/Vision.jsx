    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl font-serif">Our Vision</h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          <div>
            <div className="relative h-[320px] sm:h-[480px] lg:h-[600px] rounded-lg overflow-hidden">
              <img
            ...
            <div className="mt-4 sm:mt-6">
              <h3 className="text-lg sm:text-xl font-semibold mb-1">Max Junestrand</h3>
              <p className="text-sm text-gray-600">Co-founder & CEO</p>
            </div>
          </div>

          <div className="space-y-5 sm:space-y-6 pt-4 lg:pt-8">
